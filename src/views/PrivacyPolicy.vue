<template>
  <div class="about-container">
    ...
    <p>
      At Whyboobo, accessible from https://whyboobo.com/qrcodecontact/, one of
    ...
    <p>
      ...
      <a href="https://www.gdprprivacypolicy.net/"
        >GDPR Privacy Policy Generator from GDPRPrivacyPolicy.net</a
      >
    </p>
    ...
    <p>
      Cmevo Digital SRL legal basis for collecting and using the personal
    ...
    <ul>
      <li>Cmevo Digital SRL needs to perform a contract with you</li>
      <li>You have given Cmevo Digital SRL permission to do so</li>
      <li>
        Processing your personal information is in Cmevo Digital SRL legitimate
        interests
      </li>
      <li>Cmevo Digital SRL needs to comply with the law</li>
    </ul>

    <p>
      Cmevo Digital SRL will retain your personal information only for as long
    ...
    <p>
      Whyboobo follows a standard procedure of using log files. These files log
    ...
    <P
      ...
      advertising partners of Whyboobo.</P
    >

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Whyboobo, which are sent directly
    ...
    <p>
      Note that Whyboobo has no access to or control over these cookies that are
    ...
    <p>
      Whyboobo's Privacy Policy does not apply to other advertisers or websites.
    ...
    <p>
      Whyboobo does not knowingly collect any Personal Identifiable Information
    ...
    <p>
      ...
      the information that they shared and/or collect in Whyboobo. This policy
